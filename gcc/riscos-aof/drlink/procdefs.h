...
extern bool load_viafile(char *);
extern bool load_editfile(char *);
extern bool open_object(char *);
extern void close_object(void);
extern bool read_libchunkhdr(libheader *);
extern fileinfo examine_file(char *);
...
extern void write_mapfile(char *);
extern void close_mapfile(void);

/* -- In 'Libraries' -- */

extern void init_library(void);
extern bool addto_liblist(char *, unsigned int *, unsigned int);
...
extern bool load_wholelib(char *, unsigned int);
...
extern arealist *find_area(char *);
