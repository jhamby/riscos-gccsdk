...
int symedit_count,		/* Count of rename/hide/reveal commands */
...
*/
static void
insert_edit (editcmd ** editlist, editcmd * newedit)
{
  int hashval;
  editcmd *ep, *lastep;
  ep = *editlist;
