/* COBF by BB -- 'Heap.c' obfuscated at Fri Dec 22 16:52:42 2000
*/
#include<stdlib.h>
#include"cobf.h"
...
l408(b);a e*l181(e* );i h l274{h l274*l232;d c l649;}l274;w e*l563, *
l676;w l274*l474, *l538, *l467;w l274*l524[10+1];w d c l654;w g l686;
b*l59(d c l32){e*l475, *l666;l274*t, *l72, *l110, *k;d c l552,l567;
l32=(l32+z(c)-1)&(-(z(c)));f(l32<(z(l274)))l32=(z(l274));f(l32<=(10*z
(c))){l552=l32/z(d c);f((l72=l524[l552])!=0){l524[l552]=l72->l232;q
l72;}}f((k=l538)!=0){t=0;l26(k!=0&&k->l649<l32){t=k;k=k->l232;}f(k!=0
){l475=(e* )(k);l567=k->l649-l32;f(l567>=z(l274)){l110=(l274* )((e* )(
k)+l32);f(l567<=(10*z(c))){l552=l567/z(d c);l110->l232=l524[l552];
l524[l552]=l110;f(t==0){l538=k->l232;}r{t->l232=k->l232;}f(l467==k){
l467=t;}}r{l110->l649=l567;l110->l232=k->l232;f(t==0){l538=l110;}r{t
->l232=l110;}f(k==l467){l467=l110;}}}r{f(t==0){l538=k->l232;}r{t->
l232=k->l232;}f(l467==k){l467=t;}}q l475;}}f(l32>4096){l72=l768(l32+z
(l274));f(l72!=0){l72->l232=l474;l474=l72;l654+=l32+z(l274);q(b* )(
l72+1);}}r{l475=l563;l666=l475+l32;f(l666<l676){l563=l666;q l475;}r{
l72=l768(4096+z(l274));f(l72!=0){l72->l232=l474;l474=l72;l654+=4096+z
(l274);l475=(b* )(l72+1);l676=l475+4096;l563=l475+l32;q l475;}}}f(!
l686&&l164==l327){f(l77)u("\x44\x72\x6c\x69\x6e\x6b\x3a\x20\x4c\x69"
"\x6e\x6b\x65\x72\x20\x69\x73\x20\x72\x75\x6e\x6e\x69\x6e\x67\x20\x76"
"\x65\x72\x79\x20\x73\x68\x6f\x72\x74\x20\x6f\x66\x20\x6d\x65\x6d\x6f"
"\x72\x79");l238=l686=1;l377();l360();q l59(l32);}q 0;}b l178(b*l581,
d c l32){l274*l72;l72=l581;f(l32<=(10*z(c))){l32=l32/z(d c);l72->l232
=l524[l32];l524[l32]=l72;}r{l72->l232=0;l72->l649=l32;f(l467==0){l538
=l72;}r{l467->l232=l72;}l467=l72;}}g l368(b){c x;l474=l768(4096+z(
l274));f(l474==0){u("\x46\x61\x74\x61\x6c\x3a\x20\x54\x68\x65\x72\x65"
"\x20\x69\x73\x20\x6e\x6f\x74\x20\x65\x6e\x6f\x75\x67\x68\x20\x6d\x65"
"\x6d\x6f\x72\x79\x20\x74\x6f\x20\x72\x75\x6e\x20\x74\x68\x65\x20\x6c"
"\x69\x6e\x6b\x65\x72");}l474->l232=0;l654=4096+z(l274);l563=(e* )(
l474+1);l676=l563+4096;l88(x=0;x<=10;x++)l524[x]=0;l538=l467=0;l238=
l686=0;q 1;}b l330(b){l274*k, *l110;k=l474;l26(k!=0){l110=k->l232;
l1009(k);k=l110;}}b l359(b){u("\x44\x72\x6c\x69\x6e\x6b\x3a\x20\x4c"
"\x69\x6e\x6b\x69\x6e\x67\x20\x74\x68\x65\x20\x70\x72\x6f\x67\x72\x61"
"\x6d\x20\x72\x65\x71\x75\x69\x72\x65\x64\x20\x25\x64\x4b\x20\x62\x79"
"\x74\x65\x73\x20\x6f\x66\x20\x6d\x65\x6d\x6f\x72\x79",l654/1024);}
