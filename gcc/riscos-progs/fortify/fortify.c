 ...
 * internally by Fortify to manage its 
 ...
 * and its fortifications must be intact.
...
/*     st_Output("Checking...\n"); */
    ...
    while(curr)
    {
/*         sprintf(st_Buffer, "\nFortify: Checking block at %s.%lu\n", curr->File, curr->Line);
        st_Output(st_Buffer); */
 ...
 * is output its Address, Size, and the SourceFile and 
 ...
 * is output its Address, Size, the SourceFile and Line
 ...
 * list, and actually free its memory.
 */
static void
 ...
 * its constructor will be called at program initialization,
 * and its destructor will be called at program termination.
