...
|__builtin_next_arg|
	...
	/* void __arm_nonlocal_goto (void *frame_pointer, void *target_addr,
				     void *save_area, void *static_chain) */
	EXPORT	|__arm_nonlocal_goto|
|__arm_nonlocal_goto|
	/* Stack pointer is saved in 'save_area' by the function
	   __arm_save_stack_nonlocal.  */
	MOV	sp, a3
	/* The frame pointer gets restored by the nonlocal_goto receiver
	   which is automatically generated by GCC.   The receiver is
...
list_off		*	4
	...
	/* UnixLib's jmp_buf is 25 words, Norcroft's is 22 words
	   so gcc's is 26 (one more word than the biggest)
	   setjmp_save is the offset to the 26th word.  */
setjmp_save		*	(25*4)
...
|L..29|
	...
	/* No chunk was freed so point old_chunks to that chunk */
	CMP	old_chunks, #0
	STREQ	a1, [arm_alloca_v, #list_off]
	MOV	old_chunks, a1
	B	|L..42|
