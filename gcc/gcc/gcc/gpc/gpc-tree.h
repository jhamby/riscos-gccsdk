/* Definitions for C parsing and type checking.
   Copyright (C) 1987, 1993, 1994, 1995, 1997-2000 Free Software Foundation, Inc.
...
/* Prepare expr to be an argument to a TRUTH_NOT_EXPR,
...
#ifdef EGCS95
extern void error_init                          PROTO((const char *, const char *,
                                                       const char *));
extern void pedwarn_init                        PROTO((const char *, const char *,
                                                       const char *));
#else /* not EGCS95 */
extern void error_init                          PROTO((char *, char *, char *));
extern void pedwarn_init                        PROTO((char *, char *, char *));
#endif /* not EGCS95 */
