...
int main(int argc, char *argv[])
{
   ...
   numb=atoi(argv[1]);
   expon=atoi(argv[2]);
   printf ("numb = %d, expon = %d, argv[1] = '%s', argv[2] = '%s'\n",
   	   numb, expon, argv[1], argv[2]);
   ...
   dupexpon=expon;
   len=(int)(expon*lp)+1;
   printf ("numb = %d, expon = %d, lg = %.14f, lp = %.14f, len = %d\n",
   	   numb, expon, lg, lp, len);
   fig=(char *) calloc(len,sizeof(char));
