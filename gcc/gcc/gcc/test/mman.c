/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/gccsdk/gcc-2_95_2/gcc/test/mman.c,v $
 * $Date: 2000/07/15 14:50:46 $
 * $Revision: 1.1.1.1 $
 * $State: Exp $
 * $Author: nick $
 *
...
#ifdef EMBED_RCSID
static const char rcs_id[] = "$Id: mman.c,v 1.1.1.1 2000/07/15 14:50:46 nick Exp $";
#endif
