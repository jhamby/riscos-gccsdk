...
iconv_t iconv_open(const char *tocode, const char *fromcode)
{
  ...
  __os_cli("RMEnsure Iconv 0.01 RMload System:Modules.Iconv");
  if ((err = __os_cli("RMEnsure Iconv 0.01 Error iconv support requires the Iconv module 0.01 or newer")) != NULL ||
