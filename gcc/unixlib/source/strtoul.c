/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/gccsdk/unixlib/source/strtoul.c,v $
...
#ifdef EMBED_RCSID
static const char rcs_id[] = "$Id: strtoul.c,v 1.2.2.1 2002/02/11 13:16:40 admin Exp $";
#endif
...
unsigned long
strtoul (const char *nptr, char **end, int base)
{
  int overflow, neg = 0;
  unsigned int digit;
