/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/gccsdk/unixlib/source/math/llrintf.c,v $
 ...
 *  - Renamed __llrintf to llrintf
 *  - Change #include math_private.h to unixlib/math.h
 */
