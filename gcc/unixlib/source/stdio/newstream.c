/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/unixlib/source/stdio/c/newstream,v $
...
#ifdef EMBED_RCSID
static const char rcs_id[] = "$Id: newstream,v 1.6 2000/01/12 16:52:26 admin Exp $";
#endif
