 ...
 *    declaration too.
 *  - Disabled the #define h_errno redefintion.
 *  - Make sure there is a __set_h_errno() definition.
 *  - Changed "/etc/hosts.equiv" into "InetDBase:hosts.equiv", "/etc/hosts"
 *    into "InetDBase:hosts", "/etc/networks" into "InetDBase:networks",
 *    "/etc/nsswitch.conf" into "InetDBase:nsswitch.conf", "/etc/protocols"
 *    into "InetDBase:protocols", "/etc/services" into "InetDBase:services".
 *  - Commented out gai_strerror(), getnameinfo() declarations.
 */
...
#define	_PATH_HEQUIV		"InetDBase:hosts.equiv"
#define	_PATH_HOSTS		"InetDBase:hosts"
#define	_PATH_NETWORKS		"InetDBase:networks"
#define	_PATH_NSSWITCH_CONF	"InetDBase:nsswitch.conf"
#define	_PATH_PROTOCOLS		"InetDBase:protocols"
#define	_PATH_SERVICES		"InetDBase:services"
