/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/unixlib/source/sys/c/errlist,v $
 * $Date: 1999/08/01 12:13:40 $
 * $Revision: 1.11 $
 * $State: Exp $
 * $Author: admin $
 *
...
#ifdef EMBED_RCSID
static const char rcs_id[] = "$Id: errlist,v 1.11 1999/08/01 12:13:40 admin Exp $";
#endif
