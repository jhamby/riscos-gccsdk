/****************************************************************************
 *
 * $Source: /usr/local/cvsroot/unixlib/source/netlib/c/socket,v $
 * $Date: 1998/01/29 20:16:30 $
 * $Revision: 1.7 $
 * $State: Exp $
 * $Author: unixlib $
 *
...
#ifdef EMBED_RCSID
static const char rcs_id[] = "$Id: socket,v 1.7 1998/01/29 20:16:30 unixlib Exp $";
#endif
