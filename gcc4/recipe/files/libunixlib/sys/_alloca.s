...
noabort:
 ...
 PICEQ "LDR	a3, [v4, a3]"
	...
	ANDNE	a2, a2, #0xfc000003	@ a2 = PSR flags
...
#if __UNIXLIB_ALLOCA_FATAL
__alloca_malloc_msg:
	.ascii	"could not claim enough space for alloca"
	.byte	13, 10, 0
#endif

__alloca_rtn_msg:
	.ascii	"return from alloca() not possible, return point corrupted"
	.byte	13, 10, 0
	.align
...
@ the caller (__pthread_exit).
	.global	__alloca_thread_free_all
