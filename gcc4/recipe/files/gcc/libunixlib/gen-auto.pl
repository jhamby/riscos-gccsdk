...
print MAKE "crt0.o: crt/crt0.s\n";
print MAKE "\t\$(CCASCOMPILE) -o crt0.o -c \`test -f \'crt/crt0.s\' || echo \'\$(srcdir)/\'\`crt/crt0.s\n";
print MAKE "gcrt0.o: crt/gcrt0.s\n";
print MAKE "\t\$(CCASCOMPILE) -o gcrt0.o -c \`test -f \'crt/gcrt0.s\' || echo \'\$(srcdir)/\'\`crt/gcrt0.s\n\n";
