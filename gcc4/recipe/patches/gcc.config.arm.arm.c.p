--- gcc/config/arm/arm.c.orig	2007-01-21 20:27:37.000000000 +0100
+++ gcc/config/arm/arm.c	2007-01-21 19:11:58.000000000 +0100
@@ -52,6 +52,7 @@
...
+	{
+	  tree ftree;
+	  /* printf ("legitimize_pic_address: sym=%s, local=%d, constp=%d\n",
+		  XSTR (orig, 0),
