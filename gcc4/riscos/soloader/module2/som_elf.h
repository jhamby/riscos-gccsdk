...
extern _kernel_oserror *elffile_load(elf_file *file, som_PTR load_offset, bool init_bss);

extern _kernel_oserror *elffile_from_memory(elf_file *loader, som_PTR base_addr);
...
static inline som_PTR elffile_entry_point(elf_file *file)
{
som_PTR base = (file->base_addr == (som_PTR)0x8000) ? NULL : file->base_addr;
