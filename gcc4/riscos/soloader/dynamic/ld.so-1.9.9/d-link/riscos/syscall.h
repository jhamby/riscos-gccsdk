...
#define XSOM_PROLOGUE		(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x0)
#define XSOM_RESOLVER		(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x1)
#define XSOM_ALLOC		(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x2)
#define XSOM_FREE		(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x3)
#define XSOM_ALLOC_LIB		(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x4)
#define XSOM_REGISTER_OBJECT	(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x5)
#define XSOM_DEREGISTER_CLIENT	(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x6)
#define XSOM_DEREGISTER_OBJECT	(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x7)
#define XSOM_QUERY_OBJECT	(SOM_SWI_CHUNK_BASE + SWI_X_BIT + 0x8)
