...
+	$(CXX) $(CXXFLAGS) -static -o !RunImage$(AB_EXEEXT) $(OBJS) -L ../DrawFile -lDrawFile -L ../GuiLib/GuiFlex -lGuiFlex -L ../GuiLib/Task -lGuiTask -L ../GuiLib/Util -lGuiUtil -L ../GuiLib/Wimp -lGuiWimp -L ../xpdf -lpdf -L ../xpdf/xpdf/goo -lGoo -L ../xpdf/xpdf/fofi -lfofi -L ../xpdf/xpdf/splash -lsplash -L/linux1/gccsdk/env/lib -lfreetype -lpng -lz -lstdc++ -lbz2
