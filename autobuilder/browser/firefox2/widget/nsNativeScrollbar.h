...
// nsNativeScrollbar
//
// A wrapper around a RISC OS native scrollbar that knows how to work
// with a stub gecko frame to scroll in the GFXScrollFrame mechanism
//


class nsNativeScrollbar : public nsWidget, public nsINativeScrollbar
{
public:
                nsNativeScrollbar();
...
private:
  ...
  void DoScrollAction(int);
  NS_IMETHODIMP SetScroll(void);

  static void ScrollEvent(void *ref, int newPos);
