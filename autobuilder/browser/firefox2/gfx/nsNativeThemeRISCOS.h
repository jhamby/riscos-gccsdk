...
class nsNativeThemeRISCOS: private nsNativeTheme,
                        public nsITheme,
                        public nsIObserver {
public:
  NS_DECL_ISUPPORTS
  ...
  nsNativeThemeRISCOS();
  virtual ~nsNativeThemeRISCOS();

private:
//  PRBool GetRISCOSWidgetAndState(PRUint8 aWidgetType, nsIFrame* aFrame,
//                              RISCOSThemeWidgetType& aRISCOSWidgetType,
//                              RISCOSWidgetState* aState, gint* aWidgetFlags);
