--- trunk/makefile.linux.orig	2010-08-20 20:08:52.000000000 +0100
+++ trunk/makefile.linux	2010-08-20 19:51:16.000000000 +0100
@@ -1,5 +1,5 @@
...
+CFLAGS=-Wall -static `sdl-config --cflags --libs` -funroll-loops -fomit-frame-pointer -pipe -O3 -lSDL_mixer -lvorbisidec -logg -lmikmod -lFLAC
 CC=gcc
