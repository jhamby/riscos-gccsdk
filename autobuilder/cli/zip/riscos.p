...
+    while ((name = readd(dir)) != 0) {
         if (MATCH(wildtail, name, 0)) {
             ...
             if (subwild) {
diff -r -u -N ./acorn/GMakefile ../zip30-joty/acorn/GMakefile
--- ./acorn/GMakefile	2009-01-17 20:07:14.000000000 +0100
+++ ../zip30-joty/acorn/GMakefile	2009-01-18 13:50:45.000000000 +0100
@@ -2,126 +2,102 @@
